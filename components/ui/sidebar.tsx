...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-[2.55rem]", className)}
      {...props}
    />
  );
}
...
function SidebarLineDivider({
  className,
  ...props
}: React.ComponentProps<typeof LineDivider>) {
  return (
    <LineDivider
      data-slot="sidebar-LineDivider"
      data-sidebar="LineDivider"
      className={cn("bg-divider-main w-auto", className)}
      {...props}
    />
  );
}
